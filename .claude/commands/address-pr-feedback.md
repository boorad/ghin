...
Look for the `<summary>Outside diff range comments (N)</summary>` section in the body. Parse these -- they contain file paths, line numbers, and the same comment format as inline comments.
...
- **Quality checks**: Pass/fail status

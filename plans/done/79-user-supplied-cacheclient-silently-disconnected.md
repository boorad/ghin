...
- [x] Phase 3 — GhinClient hop: test in `src/client/ghin/index.test.ts` that a class-based cache passed to `new GhinClient(...)` reaches `RequestClient` by reference
- [x] Phase 4 — changeset (`patch`) + full gate
